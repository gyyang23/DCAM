...
if __name__ == '__main__':
    ...
    # Output Path
    parser.add_argument("--work_space", default="./", type=str)  # set your path
    parser.add_argument("--log_name", default="sample_train_eval", type=str)
    parser.add_argument("--irn_weights_name", default="res50_irn(dcam).pth", type=str)
    parser.add_argument("--cam_out_dir", default="voc_cam_mask", type=str)
    parser.add_argument("--ir_label_out_dir", default="ir_label", type=str)
    parser.add_argument("--sem_seg_out_dir", default="voc_sem_seg", type=str)
    parser.add_argument("--ins_seg_out_dir", default="ins_seg", type=str)
    parser.add_argument("--cam_weight_dir", default="cam_weight", type=str)
    parser.add_argument("--dcam_weight_dir", default="dcam_weight", type=str)
    parser.add_argument("--dcam_sce_weight_dir", default="dcam_sce_weight", type=str)

    # Step
    parser.add_argument("--train_cam_pass", type=str2bool, default=False)
    parser.add_argument("--train_dcam_pass", type=str2bool, default=False)
    parser.add_argument("--train_dcam_sce_pass", type=str2bool, default=False)
    parser.add_argument("--make_cam_pass", type=str2bool, default=False)
    parser.add_argument("--make_dcam_pass", type=str2bool, default=False)
    parser.add_argument("--make_dcam_sce_pass", type=str2bool, default=False)
    ...
    args.cam_weight_dir = osp.join(args.work_space, args.cam_weight_dir)
    args.dcam_weight_dir = osp.join(args.work_space, args.dcam_weight_dir)
    args.dcam_sce_weight_dir = osp.join(args.work_space, args.dcam_sce_weight_dir)
    ...
    os.makedirs(args.cam_weight_dir, exist_ok=True)
    os.makedirs(args.dcam_weight_dir, exist_ok=True)
    os.makedirs(args.dcam_sce_weight_dir, exist_ok=True)
    ...
    if args.train_dcam_pass is True:
        import step.train_dcam

        timer = pyutils.Timer('step.train_dcam:')
        step.train_dcam.run(args)

    if args.train_dcam_sce_pass is True:
        import step.train_dcam_sce

        timer = pyutils.Timer('step.train_dcam_sce:')
        step.train_dcam_sce.run(args)
    ...
    if args.make_dcam_pass is True:
        import step.make_dcam

        timer = pyutils.Timer('step.make_dcam:')
        step.make_dcam.run(args)

    if args.make_dcam_sce_pass is True:
        import step.make_dcam_sce

        timer = pyutils.Timer('step.make_dcam_sce:')
        step.make_dcam_sce.run(args)
